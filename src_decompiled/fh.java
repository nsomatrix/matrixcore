...
public final class fh {
    ...
    public final void c(int n2, int n3, int n4, int n5, int n6, int n7) {
        this.a.drawArc(n2 *= b, n3 *= b, n4 *= b, n5 *= b, llIII[1], llIII[2]);
    }
    ...
    private static void llll() {
        llIII = new int[3];
        fh.llIII[0] = " ".length();
        fh.llIII[1] = (0xA ^ 0x53) & ~(0x3C ^ 0x65);
        fh.llIII[2] = (0x2A ^ 7) << "   ".length();
    }
}
